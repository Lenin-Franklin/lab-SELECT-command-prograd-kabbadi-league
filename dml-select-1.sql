...
SELECT EVENTS_NUMBER,CLOCK_IN_SECONDS FROM EVENT ORDER BY EVENT_NO ASC;
...
SELECT EVENT_NO,RAID_POINTS,DEFENCE_POINTS
FROM EVENT,GAME
...
WHER GAME_DATE=TO_DATE('09-MAR-2020','DD-MM-YYYY')
...
SELECT STADIUM_NAME
FROM GAME,VENUE
WHERE GATE_DATE=TO_DATE('09-MAR-2020','DD-MM-YYYY')
